    ...
    return function init(_scion) {
        ...
        var _instance = {
            ...
            setDataModel: function(name, object) {
                _scion._datamodel[name].set(object);
            },
            /**
             * Add a global variable to the scxml model
             * @param {String} name   Name of variable
             * @param {Object} object Value of the variable
             */
            addDataModel: function(name, object) {
            ...
            getDataModel: function(name) {
                try {
                    return _scion._datamodel[name].get();
                } catch(err) {
             ...
             * @param {Integer} raise   
             */
            execScript: function(stateId, data, when) {
                var actionId;
                if (when !== 'onexit') {
                    actionId = _scion.model.states.filter(function(state) {
